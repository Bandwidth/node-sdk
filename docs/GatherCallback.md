...
**digits** | **string** | (optional) The digits, letters, and/or symbols entered by the user. The string is empty if a timeout occurred before any buttons were pressed. | [optional] [default to undefined]
...
**terminatingDigit** | **string** | (optional) The digit the user pressed to end the gather. Empty string value if no terminating digit was pressed. | [optional] [default to undefined]
...
```typescript
import { GatherCallback } from 'bandwidth-sdk';

const instance: GatherCallback = {
    eventType,
    eventTime,
    accountId,
    applicationId,
