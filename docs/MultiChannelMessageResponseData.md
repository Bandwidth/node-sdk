...
**channelList** | [**Array&lt;MultiChannelChannelListResponseObject&gt;**](MultiChannelChannelListResponseObject.md) | A list of message bodies. The messages will be attempted in the order they are listed. Once a message sends successfully, the others will be ignored. | [default to undefined]
