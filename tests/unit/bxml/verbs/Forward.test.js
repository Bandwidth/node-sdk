...
describe('Forward', () => {
    const attributes = {
        ...
        from: '+19195554321',
        callTimeout: 5,
        diversionTreatment: 'propogate',
        diversionReason: 'user-busy',
        uui: '93d6f3c0be5845960b744fa28015d8ede84bd1a4;encoding=base64,asdf;encoding=jwt'
    };

    const expected = '<Forward to="+19195551234" from="+19195554321" callTimeout="5" diversionTreatment="propogate" diversionReason="user-busy" uui="93d6f3c0be5845960b744fa28015d8ede84bd1a4;encoding=base64,asdf;encoding=jwt"/>';
